...
public class LoginByFB extends Pages{
	...
	public static void testReportLoginByFb() throws Exception {
		LoginByFB loginByFB = new LoginByFB();
		loginByFB.testLoginByFB();
		driver.closeApp();
	}
	@Test
	public void testLoginByFB() throws Exception {
		...
		check_flow_login_with_FB();
	}

	public static void check_flow_login_with_FB() throws Exception {
...
//		}
	...
	private static void onbordingLoginFB() throws Exception {
		OnbordingPage().clickOnAllow();
		OnbordingPage().LoginByFb();
